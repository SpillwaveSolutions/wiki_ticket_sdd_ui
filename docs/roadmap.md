...
doc_type: roadmap
truth_state: current
source_hash: 35c22ce8
generated_at: 2026-07-23T00:57:35Z
---
...
| # | Item | Type | Priority | Status | Blocked by |
|---|---|---|---|---|---|
| [11](https://github.com/SpillwaveSolutions/wiki_ticket_sdd_ui/issues/11) | Friendlier empty states when docs/.index is absent: Docs/Traceability show raw 'not found' error banner — suggest 'run worklog ia-index' guidance instead | task | P3 | todo | — |
